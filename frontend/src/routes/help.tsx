...
export const Route = createFileRoute("/help")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Documentation, shortcuts, and support for getting the most out of PaperLens.",
      },
          ...
          {[
            {
              ...
              desc: "Upload, analyze, and read your first paper.",
            },
            {
              icon: Keyboard,
              title: "Shortcuts",
              desc: "Navigate PaperLens without leaving the keyboard.",
            },
            {
              icon: MessageSquare,
              title: "Contact us",
              desc: "Reach the team for questions or feedback.",
            },
          ].map((c) => (
            <div
              key={c.title}
